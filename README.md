...
| Phase | Scope | Status |
|-------|-------|--------|
| 1 | Planning, architecture, folder structure, DB/API/security design, threat model, CI skeleton | ✅ current |
| 2 | Backend foundation (auth, JWT, DB, Redis, logging, config) | pending |
